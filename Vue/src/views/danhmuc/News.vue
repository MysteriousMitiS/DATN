...
const editNews = (data) => {
  ...
  if (typeof data.StartDate == "string") {
    ...
    StartDateConvert.value = new Date(
      startDay[2] + "/" + startDay[1] + "/" + startDay[0]
    );
  }
      ...
      <div class="grid formgrid m-2">
        <div style="display: flex" class="field col-12 md:col-12">
          <div class="col-8 p-0">
            <div class="col-12 p-0">
              ...
              <small
                v-if="
                  (v$.News_Name.$invalid && submitted) ||
                  v$.News_Name.$pending.$response
                "
        ...
        <div class="field col-12 md:col-12">
          <label class="col-12 text-left p-0"
            >Nội dung <span class="redsao">(*)</span></label
          >
          ...
          <small
            v-if="
              (v$.Details.$invalid && submitted) ||
              v$.Details.$pending.$response
            "
            class="col-8 p-error p-0"
          >
            <span class="col-12 p-0">{{

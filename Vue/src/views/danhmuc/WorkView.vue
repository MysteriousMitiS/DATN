...
const pStatus = ref([
  ...
  { name: 'Làm lại', code: 3 },
  { name: 'Không hoàn thành', code: 4 },
  { name: 'Hoàn thành', code: 5 }
])
const pUserW = ref([])
const rules = {
  WorkName: {
...
const checkStage = store.getters.checkStage
    ...
    ;(async () => {
      await axios
        .post(
          ...
          {
            proc: 'Stage_Get',
            par: [{ par: 'StageId', va: store.getters.stageid }]
          },
          config
        )
        .then((response) => {
      ...
      await axios
        .post(
          ...
          {
            proc: 'Project_Get',
            par: [{ par: 'ProjectId', va: stage.value.ProjectId }]
          },
          config
        )
        .then((response) => {
      ...
      .post(
        baseURL + '/api/Proc/CallProc',
        {
          ...
          par: [
            ...
            { par: 'StageId', va: store.getters.stageid }
          ]
        },
        config
      )
  ...
  if (!isSaveWork.value) {
    ;(async () => {
      ...
      await axios
        ...
        .then((response) => {
          let data = JSON.parse(response.data.data)[0]
          console.log(work.value.WorkCode)
          checkuserlist.value = []
    ...
    <div class="d-container">
      <div class="d-lang-header">
        <h3 class="d-module-title">
          Dự án: {{ project.ProjectName }} > Giai đoạn: {{ stage.StageTarget }}
        </h3>
        <h3><i class="pi pi-folder"></i> Danh sách công việc</h3>
      </div>
      <div class="surface-0 d-lang-header"></div>
      <Toolbar class="d-toolbar">
        ...
        <template #end>
          ...
          />
          <Button
            @click="openBasic('Thêm công việc')"
        ...
        <div class="grid formgrid m-2">
          ...
          <div style="display: flex" class="col-12 field md:col-12">
            <div class="field col-6 md:col-6 p-0">
              ...
              <Calendar v-model="work.WorkStart" class="col-6 ip36 p-0" />
            </div>
            <div class="field col-6 md:col-6 p-0">
              <label class="col-5 text-left">Ngày kết thúc </label>
              <Calendar v-model="work.WorkEnd" class="col-7 ip36 p-0" />
            </div>
          </div>
          <div v-if="isSaveWork" class="col-12 flex field md:col-12">
            <div class="field col-6 md:col-6 p-0">
              <label class="col-6 text-left">Ngày hoàn thành </label>
              <Calendar v-model="work.WorkCompleted" class="col-6 ip36 p-0" />
            </div>
            <div class="field col-6 md:col-6 p-0">
          ...
          <div class="col-12 field md:col-12">
            <div class="col-6 flex p-0">
              ...
              <InputNumber v-model="work.STT" class="col-6 p-0 m-0" />
            </div>
          </div>
          <div class="col-12 flex field md:col-12">
            <div class="field col-6 md:col-6 p-0">
              ...
              <div style="display: flex" class="field col-12 md:col-12 p-0">
                <small v-if="workuserShow" class="col-12 p-error">
                  <span class="col-12 p-0">Người thực hiện không được phép trống</span>
                </small>
              </div>
            </div>
            <div class="field col-6 md:col-6">
              ...
              <div style="display: flex" class="field col-12 md:col-12 p-0">
                <small v-if="checkuserShow" class="col-12 p-error p-0">
                  <span class="col-12 p-0">Người giám sát không được phép trống</span>
                </small>
                <small v-if="checkuserDup" class="col-12 p-error p-0">
                  <span class="col-12 p-0">Người giám sát không trùng với người thực hiện</span>
                </small>
              </div>
            </div>
          </div>
